...
import randomImage from '../../../assets/onboarding/log in/Capture.png'; // Import your random image here
import './style.css';
          ...
          <form onSubmit={handleSubmit}>
            ...
            <div className='mt-4 flex flex-col gap-4'>
              ...
              <div className="flex gap-12 items-center ">
                ...
                <div>
                  <p>I already have an account? <NavLink style={{textDecoration: "underline"}} to='login'>login</NavLink>
                   </p>
                </div>
              </div>
            </div>
